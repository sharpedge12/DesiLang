...
{
public:
	DesiLangError(string msgIn, ErrorPriority priorityIn, Token tokenIn = nullptr);
...
// typedef shared_ptr<DesiLangError> Err;

// Err makeError(string msgIn, ErrorPriority priorityIn, Token tokenIn=nullptr) {return Err(new DesiLangError(msgIn, priorityIn, tokenIn));}
